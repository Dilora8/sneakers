<template>
  <div class="card">
    <div class="img">
      <img :src="require(`~/assets/images/${info.img}`)" alt="" />
    </div>
    <div class="text">
      <p>{{ info.text }}</p>
    </div>
    <div class="bottom">
      ...
      <div>
        ...
        <div class="add_sebet" v-if="info.added === 0" @click="add">
    ...
    <div class="new" v-if="info.new"><P>Täze</P></div>
    <div class="percent" v-if="info.discount">
      <p>%</p>
    </div>
  </div>
</template>
